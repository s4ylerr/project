...
<div class="left col-md-8">
		   <div id="sliderFrame">
	        <div id="slider">
            <?php
                $select_rec = "SELECT * FROM recipes WHERE size_photo > 0 AND date_deleted IS NULL ORDER BY id DESC LIMIT 4 ";
        ...
        <div id="thumbs">
        <?php
            $select_recipe = "SELECT * FROM recipes WHERE size_photo > 0 AND date_deleted IS NULL ORDER BY id DESC LIMIT 4 ";
...
<?php
    ...
    $select_last_five_recipe = "SELECT * FROM recipes WHERE date_deleted IS NULL ORDER BY id DESC LIMIT 7";
    ...
    if (mysqli_num_rows($row_five_recipes) > 0) {
        while ($r = mysqli_fetch_assoc($row_five_recipes)) {
            ...
            echo '&nbsp;&nbsp;' . shorter($r['name'], 45) . '</h4></a></li>';
        }
    }
...
<div class="h3"></div>
    ...
    <?php
        $select_last_article = "SELECT * FROM articles WHERE date_deleteed IS NULL ORDER BY id_article DESC LIMIT 1";
